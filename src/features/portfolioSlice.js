...
export const { fetchPortfolio, fetchRepositories, fetchError } =
    portfolioSlice.actions;

export const selectPortfolioSliceState = (state) => state.portfolio;
export const selectPortfolio = (state) =>
    selectPortfolioSliceState(state).portfolio;
export const selectPortfolioState = (state) =>
    selectPortfolioSliceState(state).portfolioState;
